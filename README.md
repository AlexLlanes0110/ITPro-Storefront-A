...
## Convenciones de alcance
- Cambios “menores” = contenido, imágenes, copy, reorden de secciones, ajustes visuales.
- Cambios “mayores” = nuevas funcionalidades, integraciones, rediseño, CMS/admin, pagos, etc.

---

## Licencia
- **TBD** (recomendación: MIT para plantilla propia).
- Si se reutilizan piezas de terceros, se respetarán sus licencias y atribuciones.
